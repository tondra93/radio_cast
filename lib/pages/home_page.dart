...
import 'package:radio_cast/model/radio.dart';
import 'package:radio_cast/utils/ai_util.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  setupAlan(){
    AlanVoice.addButton(
     ...
     "cbbb0efb6bf452592ffa478ce74663ca2e956eca572e1d8b807a3e2338fdd0dc/stage",
      ...
      body: Stack(
        children: [
          VxAnimatedBox()
              ...
              .make(),
          [AppBar(
            title: "Radio_Cast".text.xl4.bold.white.make().shimmer(
